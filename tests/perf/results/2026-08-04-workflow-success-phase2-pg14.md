...
| | |
|---|---|
| measured | 2026-08-04T22:23:58+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 11.032 ms | 11.193 ms | +0.162 ms | +0.124 to +0.199 ms | 1.103 ms | PASS |
| p99 | 28.830 ms | 28.990 ms | +0.160 ms | -1.403 to +1.024 ms | 4.324 ms | PASS |
...
| WAL records per terminal task row | 37.40 | 37.44 |
| WAL bytes per terminal task row | 3372 | 3393 |
