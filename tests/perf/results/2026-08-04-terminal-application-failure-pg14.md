...
| | |
|---|---|
| measured | 2026-08-04T22:18:35+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 3.399 ms | 3.792 ms | +0.393 ms | +0.354 to +0.427 ms | 0.500 ms | PASS |
| p99 | 8.002 ms | 8.592 ms | +0.590 ms | +0.100 to +0.919 ms | 1.500 ms | PASS |
...
| WAL records per terminal task row | 11.69 | 11.72 |
| WAL bytes per terminal task row | 1188 | 1204 |
