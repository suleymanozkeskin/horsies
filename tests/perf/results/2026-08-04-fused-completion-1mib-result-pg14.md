...
| | |
|---|---|
| measured | 2026-08-04T22:15:22+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 35.102 ms | 35.351 ms | +0.250 ms | +0.196 to +0.294 ms | 1.755 ms | PASS |
| p99 | 48.727 ms | 48.503 ms | -0.224 ms | -1.267 to +0.459 ms | 4.873 ms | PASS |
...
| WAL bytes per terminal task row | 14453 | 14473 |
