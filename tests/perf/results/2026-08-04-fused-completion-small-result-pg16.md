...
| | |
|---|---|
| measured | 2026-08-04T22:29:20+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 2.481 ms | 2.644 ms | +0.163 ms | +0.158 to +0.168 ms | 0.200 ms | PASS |
| p99 | 3.324 ms | 3.649 ms | +0.325 ms | +0.222 to +0.477 ms | 1.000 ms | PASS |
...
| WAL records per terminal task row | 16.73 | 16.74 |
| WAL bytes per terminal task row | 1667 | 1684 |
