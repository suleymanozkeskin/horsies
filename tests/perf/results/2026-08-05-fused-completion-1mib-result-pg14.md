...
| | |
|---|---|
| measured | 2026-08-05T00:30:45+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 33.345 ms | 33.541 ms | +0.196 ms | +0.172 to +0.219 ms | 1.667 ms | PASS |
| p99 | 38.864 ms | 38.891 ms | +0.027 ms | -0.882 to +0.792 ms | 3.886 ms | PASS |
...
| shared hit blocks | 57 | 85 |
| shared read blocks | 1 | 1 |
...
| WAL records per terminal task row | 31.37 | 31.34 |
| WAL bytes per terminal task row | 14425 | 14444 |
