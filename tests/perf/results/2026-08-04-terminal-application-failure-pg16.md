...
| | |
|---|---|
| measured | 2026-08-04T22:43:03+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 1.925 ms | 2.067 ms | +0.141 ms | +0.138 to +0.144 ms | 0.500 ms | PASS |
| p99 | 2.448 ms | 2.655 ms | +0.207 ms | +0.080 to +0.293 ms | 1.500 ms | PASS |
...
| WAL records per terminal task row | 11.68 | 11.70 |
| WAL bytes per terminal task row | 1186 | 1204 |
