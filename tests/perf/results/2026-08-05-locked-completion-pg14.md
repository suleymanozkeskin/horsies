...
| | |
|---|---|
| measured | 2026-08-05T00:31:54+00:00 |
...
|---|---|---|---|---|---|---|
| p50 | 1.894 ms | 2.031 ms | +0.137 ms | +0.133 to +0.140 ms | 0.500 ms | PASS |
| p99 | 2.560 ms | 2.680 ms | +0.120 ms | -0.008 to +0.220 ms | 1.500 ms | PASS |
...
| WAL records per terminal task row | 10.69 | 10.72 |
