# showcase/acme/workflows/seasonal_markdown.py
...
class SeasonalMarkdown(WorkflowDefinition[SalesRollup]):
    ...
    definition_key = 'acme.seasonal_markdown.v1'
...
_CHECK_SKUS: Final[list[str]] = [f'ACME-SKU-{index:04d}' for index in range(1, 7)]
