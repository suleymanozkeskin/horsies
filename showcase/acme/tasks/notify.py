...
workflow still fails by policy; the customer still hears from Acme Clothing.
"""
    ...
    *,
    ...
    match store.get_order(order_id):
        ...
        case Ok(order):
            ...
            recipient = f'{order.customer_id}@customers.acme.invalid'
