# showcase/hemline/tasks/shipping.py
...
def print_label(
    *,
    ...
    label_url = f'https://labels.hemline.invalid/{booked.booking_reference}.pdf'
...
def tracking_seed(
    *,
    ...
    tracking_code = f'HEM{simulate.integer(10_000_000, 99_999_999, order_id, "track")}'
