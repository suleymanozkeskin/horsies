...
class OperationalErrorCode(str, Enum):
    ...
    LEGACY_SERDE_TAG_UNSUPPORTED = 'LEGACY_SERDE_TAG_UNSUPPORTED'
    UNKNOWN_SERDE_TAG = 'UNKNOWN_SERDE_TAG'
...
class ContractCode(str, Enum):
    ...
    RESERVED_KEY_IN_USER_DATA = 'RESERVED_KEY_IN_USER_DATA'
    UNREGISTERED_REHYDRATION_TYPE = 'UNREGISTERED_REHYDRATION_TYPE'
    SPOOFED_SERIALIZATION_IDENTITY = 'SPOOFED_SERIALIZATION_IDENTITY'
